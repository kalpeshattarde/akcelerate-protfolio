...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with startup_pre_launch-specific behavior.
...
- [ ] A real startup_pre_launch data model exists beyond shared scaffold entities.
- [ ] At least one true startup_pre_launch workflow is implemented end to end.
