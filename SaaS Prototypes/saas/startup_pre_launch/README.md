...
# startup_pre_launch Prototype

startup_pre_launch is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true startup_pre_launch implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `startup_prelaunch_1768023513268`
...
- Any domain-specific startup_pre_launch model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true startup_pre_launch domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with startup_pre_launch-specific behavior.
