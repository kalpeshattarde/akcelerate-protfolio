...
## startup_pre_launch Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real startup_pre_launch.

## Phase 2: Replace The Shared Scaffold
- Define the true startup_pre_launch domain model.
