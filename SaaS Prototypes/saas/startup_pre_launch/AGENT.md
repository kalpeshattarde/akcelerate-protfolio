...
## Agent Rules For The startup_pre_launch Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real startup_pre_launch exists in code.
...
- Any attempt to present this scaffold as a finished startup_pre_launch.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real startup_pre_launch, add the domain model first.
