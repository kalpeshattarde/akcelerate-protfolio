...
## Stable Context For startup_pre_launch
...
### Missing Domain Work
- A true startup_pre_launch data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished startup_pre_launch until the code actually stops being the shared VelocityCore scaffold.
