...
# esg_reporting Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the esg_reporting prototype. It is not the canonical working tree for this prototype. Use the top-level `esg_reporting/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: esg_reporting
...
## How To Use It
1. Prefer the top-level `esg_reporting/README.md` for current guidance.
