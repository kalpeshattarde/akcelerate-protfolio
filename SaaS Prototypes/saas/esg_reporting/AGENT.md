...
## Agent Rules For The esg_reporting Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real esg_reporting exists in code.
...
- Any attempt to present this scaffold as a finished esg_reporting.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real esg_reporting, add the domain model first.
