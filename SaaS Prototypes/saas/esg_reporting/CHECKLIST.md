...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with esg_reporting-specific behavior.
...
- [ ] A real esg_reporting data model exists beyond shared scaffold entities.
- [ ] At least one true esg_reporting workflow is implemented end to end.
