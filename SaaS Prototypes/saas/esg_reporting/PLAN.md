...
## esg_reporting Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real esg_reporting.

## Phase 2: Replace The Shared Scaffold
- Define the true esg_reporting domain model.
