...
## Stable Context For esg_reporting
...
### Missing Domain Work
- A true esg_reporting data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished esg_reporting until the code actually stops being the shared VelocityCore scaffold.
