...
# BOLT Advanced Prompt - esg_reporting

Work in this prototype root only.

## Code Truth
- The top-level esg_reporting directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real esg_reporting.
2. If converting, add the missing esg_reporting data model and workflows first.
