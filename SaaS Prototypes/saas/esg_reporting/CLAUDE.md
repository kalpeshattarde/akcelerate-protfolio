...
Use this directory as the esg_reporting prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished esg_reporting unless the code actually implements that domain.
...
2. If converting this into a true esg_reporting, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended esg_reporting direction.
