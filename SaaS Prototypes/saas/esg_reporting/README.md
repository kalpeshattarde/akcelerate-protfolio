...
# esg_reporting Prototype

esg_reporting is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true esg_reporting implementation.
...
- Any domain-specific esg_reporting model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true esg_reporting domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with esg_reporting-specific behavior.
