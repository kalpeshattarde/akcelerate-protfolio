...
# video_conferencing Prototype

video_conferencing is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true video_conferencing implementation.
...
- Archive paths:
  ...
  - `video_conferencing_1767971020270`
...
- Any domain-specific video_conferencing model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true video_conferencing domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with video_conferencing-specific behavior.
