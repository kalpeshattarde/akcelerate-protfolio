...
# BOLT Advanced Prompt - video_conferencing

Work in this prototype root only.

## Code Truth
- The top-level video_conferencing directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real video_conferencing.
2. If converting, add the missing video_conferencing data model and workflows first.
