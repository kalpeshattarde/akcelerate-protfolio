...
## Product Direction
- Prototype label: video_conferencing
- Intended product: video_conferencing
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a video_conferencing product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a video_conferencing product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future video_conferencing product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real video_conferencing workflow.
...
- video_conferencing domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true video_conferencing workflow.
...
### Free
- Audience: Builders evaluating the video_conferencing prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted video_conferencing workflow.
...
3. Replace one generic scaffold workflow with a real video_conferencing workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with video_conferencing-specific behavior.
