...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with video_conferencing-specific behavior.
...
- [ ] A real video_conferencing data model exists beyond shared scaffold entities.
- [ ] At least one true video_conferencing workflow is implemented end to end.
