...
## Stable Context For video_conferencing
...
### Missing Domain Work
- A true video_conferencing data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished video_conferencing until the code actually stops being the shared VelocityCore scaffold.
