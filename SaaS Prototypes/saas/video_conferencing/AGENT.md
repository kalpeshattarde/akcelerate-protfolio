...
## Agent Rules For The video_conferencing Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real video_conferencing exists in code.
...
- Any attempt to present this scaffold as a finished video_conferencing.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real video_conferencing, add the domain model first.
