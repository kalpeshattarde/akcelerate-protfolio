...
## video_conferencing Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real video_conferencing.

## Phase 2: Replace The Shared Scaffold
- Define the true video_conferencing domain model.
