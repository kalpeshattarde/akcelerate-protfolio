...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with business-specific behavior.
...
- [ ] A real business data model exists beyond shared scaffold entities.
- [ ] At least one true business workflow is implemented end to end.
