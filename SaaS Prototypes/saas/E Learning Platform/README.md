...
E Learning Platform is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true E Learning Platform implementation.
...
- Any domain-specific E Learning Platform model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true E Learning Platform domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with E Learning Platform-specific behavior.
