...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with E Learning Platform-specific behavior.
...
- [ ] A real E Learning Platform data model exists beyond shared scaffold entities.
- [ ] At least one true E Learning Platform workflow is implemented end to end.
