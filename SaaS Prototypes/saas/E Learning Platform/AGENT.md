...
## Agent Rules For The E Learning Platform Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real E Learning Platform exists in code.
...
- Any attempt to present this scaffold as a finished E Learning Platform.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real E Learning Platform, add the domain model first.
