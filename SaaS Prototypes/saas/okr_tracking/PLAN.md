...
## okr_tracking Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real okr_tracking.

## Phase 2: Replace The Shared Scaffold
- Define the true okr_tracking domain model.
