...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with okr_tracking-specific behavior.
...
- [ ] A real okr_tracking data model exists beyond shared scaffold entities.
- [ ] At least one true okr_tracking workflow is implemented end to end.
