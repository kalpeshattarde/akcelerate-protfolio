...
## Agent Rules For The okr_tracking Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real okr_tracking exists in code.
...
- Any attempt to present this scaffold as a finished okr_tracking.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real okr_tracking, add the domain model first.
