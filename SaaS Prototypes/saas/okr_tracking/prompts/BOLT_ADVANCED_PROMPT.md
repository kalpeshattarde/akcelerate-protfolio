...
# BOLT Advanced Prompt - okr_tracking

Work in this prototype root only.

## Code Truth
- The top-level okr_tracking directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real okr_tracking.
2. If converting, add the missing okr_tracking data model and workflows first.
