...
## Stable Context For okr_tracking
...
### Missing Domain Work
- A true okr_tracking data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished okr_tracking until the code actually stops being the shared VelocityCore scaffold.
