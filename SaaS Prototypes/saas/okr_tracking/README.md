...
# okr_tracking Prototype

okr_tracking is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true okr_tracking implementation.
...
- Any domain-specific okr_tracking model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true okr_tracking domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with okr_tracking-specific behavior.
