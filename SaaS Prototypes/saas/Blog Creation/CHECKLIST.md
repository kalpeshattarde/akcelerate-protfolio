...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Blog Creation-specific behavior.
...
- [ ] A real Blog Creation data model exists beyond shared scaffold entities.
- [ ] At least one true Blog Creation workflow is implemented end to end.
