...
## Agent Rules For The Blog Creation Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Blog Creation exists in code.
...
- Any attempt to present this scaffold as a finished Blog Creation.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Blog Creation, add the domain model first.
