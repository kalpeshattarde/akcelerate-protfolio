...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with saas-specific behavior.
...
- [ ] A real saas data model exists beyond shared scaffold entities.
- [ ] At least one true saas workflow is implemented end to end.
