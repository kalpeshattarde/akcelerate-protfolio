...
# marketing_analytics Prototype

marketing_analytics is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true marketing_analytics implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `marketing_analytics_1768025911512`
...
- Any domain-specific marketing_analytics model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true marketing_analytics domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with marketing_analytics-specific behavior.
