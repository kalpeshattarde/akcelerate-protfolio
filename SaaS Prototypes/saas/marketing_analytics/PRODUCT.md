...
## Product Direction
- Prototype label: marketing_analytics
- Intended product: marketing_analytics
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a marketing_analytics product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a marketing_analytics product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future marketing_analytics product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real marketing_analytics workflow.
...
- marketing_analytics domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true marketing_analytics workflow.
...
### Free
- Audience: Builders evaluating the marketing_analytics prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted marketing_analytics workflow.
...
3. Replace one generic scaffold workflow with a real marketing_analytics workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with marketing_analytics-specific behavior.
