...
## marketing_analytics Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real marketing_analytics.

## Phase 2: Replace The Shared Scaffold
- Define the true marketing_analytics domain model.
