...
## Agent Rules For The marketing_analytics Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real marketing_analytics exists in code.
...
- Any attempt to present this scaffold as a finished marketing_analytics.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real marketing_analytics, add the domain model first.
