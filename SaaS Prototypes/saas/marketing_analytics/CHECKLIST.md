...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with marketing_analytics-specific behavior.
...
- [ ] A real marketing_analytics data model exists beyond shared scaffold entities.
- [ ] At least one true marketing_analytics workflow is implemented end to end.
