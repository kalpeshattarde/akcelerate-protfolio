...
# BOLT Advanced Prompt - marketing_analytics

Work in this prototype root only.

## Code Truth
- The top-level marketing_analytics directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real marketing_analytics.
2. If converting, add the missing marketing_analytics data model and workflows first.
