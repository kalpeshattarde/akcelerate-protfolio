...
## Agent Rules For The Procure Order Management Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Procure Order Management exists in code.
...
- Any attempt to present this scaffold as a finished Procure Order Management.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Procure Order Management, add the domain model first.
