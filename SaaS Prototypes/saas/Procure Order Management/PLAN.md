...
## Procure Order Management Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Procure Order Management.

## Phase 2: Replace The Shared Scaffold
- Define the true Procure Order Management domain model.
