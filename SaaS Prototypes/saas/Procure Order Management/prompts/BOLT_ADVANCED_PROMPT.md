...
# BOLT Advanced Prompt - Procure Order Management

Work in this prototype root only.

## Code Truth
- The top-level Procure Order Management directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real Procure Order Management.
2. If converting, add the missing Procure Order Management data model and workflows first.
