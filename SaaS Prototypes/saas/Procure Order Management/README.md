...
# Procure Order Management Prototype

Procure Order Management is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Procure Order Management implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `procure_order_management_1767970454869`
...
- Any domain-specific Procure Order Management model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Procure Order Management domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Procure Order Management-specific behavior.
