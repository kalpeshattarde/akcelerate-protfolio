...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Procure Order Management-specific behavior.
...
- [ ] A real Procure Order Management data model exists beyond shared scaffold entities.
- [ ] At least one true Procure Order Management workflow is implemented end to end.
