...
# Sales Commision Calculator Prototype

Sales Commision Calculator is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Sales Commision Calculator implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `sales_commision_calculator_1767970840898`
...
- Any domain-specific Sales Commision Calculator model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Sales Commision Calculator domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Sales Commision Calculator-specific behavior.
