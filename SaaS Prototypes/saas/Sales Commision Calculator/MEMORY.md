...
## Stable Context For Sales Commision Calculator
...
### Missing Domain Work
- A true Sales Commision Calculator data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Sales Commision Calculator until the code actually stops being the shared VelocityCore scaffold.
