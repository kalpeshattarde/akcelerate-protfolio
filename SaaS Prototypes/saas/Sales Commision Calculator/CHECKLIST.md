...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Sales Commision Calculator-specific behavior.
...
- [ ] A real Sales Commision Calculator data model exists beyond shared scaffold entities.
- [ ] At least one true Sales Commision Calculator workflow is implemented end to end.
