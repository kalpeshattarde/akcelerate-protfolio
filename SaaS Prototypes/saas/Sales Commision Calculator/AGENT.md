...
## Agent Rules For The Sales Commision Calculator Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Sales Commision Calculator exists in code.
...
- Any attempt to present this scaffold as a finished Sales Commision Calculator.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Sales Commision Calculator, add the domain model first.
