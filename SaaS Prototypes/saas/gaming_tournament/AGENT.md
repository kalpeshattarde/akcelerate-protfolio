...
## Agent Rules For The gaming_tournament Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real gaming_tournament exists in code.
...
- Any attempt to present this scaffold as a finished gaming_tournament.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real gaming_tournament, add the domain model first.
