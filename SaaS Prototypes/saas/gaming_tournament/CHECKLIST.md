...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with gaming_tournament-specific behavior.
...
- [ ] A real gaming_tournament data model exists beyond shared scaffold entities.
- [ ] At least one true gaming_tournament workflow is implemented end to end.
