...
# gaming_tournament Prototype

gaming_tournament is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true gaming_tournament implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `gaming_tournament_hub_1768023976949`
...
- Any domain-specific gaming_tournament model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true gaming_tournament domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with gaming_tournament-specific behavior.
