...
# BOLT Advanced Prompt - gaming_tournament

Work in this prototype root only.

## Code Truth
- The top-level gaming_tournament directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real gaming_tournament.
2. If converting, add the missing gaming_tournament data model and workflows first.
