...
# job_board Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the job_board prototype. It is not the canonical working tree for this prototype. Use the top-level `job_board/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: job_board
...
## How To Use It
1. Prefer the top-level `job_board/README.md` for current guidance.
