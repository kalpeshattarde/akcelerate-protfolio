...
# BOLT Advanced Prompt - job_board

Work in this prototype root only.

## Code Truth
- The top-level job_board directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real job_board.
2. If converting, add the missing job_board data model and workflows first.
