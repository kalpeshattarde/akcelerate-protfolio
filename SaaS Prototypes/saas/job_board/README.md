...
job_board is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true job_board implementation.
...
- Any domain-specific job_board model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true job_board domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with job_board-specific behavior.
