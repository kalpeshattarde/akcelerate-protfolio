...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with job_board-specific behavior.
...
- [ ] A real job_board data model exists beyond shared scaffold entities.
- [ ] At least one true job_board workflow is implemented end to end.
