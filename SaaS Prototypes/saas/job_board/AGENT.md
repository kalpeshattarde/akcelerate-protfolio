...
## Agent Rules For The job_board Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real job_board exists in code.
...
- Any attempt to present this scaffold as a finished job_board.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real job_board, add the domain model first.
