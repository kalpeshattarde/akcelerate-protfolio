...
## Stable Context For contract_management
...
### Missing Domain Work
- A true contract_management data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished contract_management until the code actually stops being the shared VelocityCore scaffold.
