...
## Agent Rules For The contract_management Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real contract_management exists in code.
...
- Any attempt to present this scaffold as a finished contract_management.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real contract_management, add the domain model first.
