...
# contract_management Prototype

contract_management is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true contract_management implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `contract_management_1767970139317`
...
- Any domain-specific contract_management model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true contract_management domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with contract_management-specific behavior.
