...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with contract_management-specific behavior.
...
- [ ] A real contract_management data model exists beyond shared scaffold entities.
- [ ] At least one true contract_management workflow is implemented end to end.
