...
# real_estate_listing Prototype

real_estate_listing is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true real_estate_listing implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `real_estate_listing_1767962604538`
...
- Any domain-specific real_estate_listing model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true real_estate_listing domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with real_estate_listing-specific behavior.
