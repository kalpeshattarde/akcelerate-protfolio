...
## Stable Context For real_estate_listing
...
### Missing Domain Work
- A true real_estate_listing data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished real_estate_listing until the code actually stops being the shared VelocityCore scaffold.
