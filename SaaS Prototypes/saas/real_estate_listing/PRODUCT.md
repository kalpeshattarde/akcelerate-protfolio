...
## Product Direction
- Prototype label: real_estate_listing
- Intended product: real_estate_listing
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a real_estate_listing product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a real_estate_listing product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future real_estate_listing product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real real_estate_listing workflow.
...
- real_estate_listing domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true real_estate_listing workflow.
...
### Free
- Audience: Builders evaluating the real_estate_listing prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted real_estate_listing workflow.
...
3. Replace one generic scaffold workflow with a real real_estate_listing workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with real_estate_listing-specific behavior.
