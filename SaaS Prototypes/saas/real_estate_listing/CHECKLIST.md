...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with real_estate_listing-specific behavior.
...
- [ ] A real real_estate_listing data model exists beyond shared scaffold entities.
- [ ] At least one true real_estate_listing workflow is implemented end to end.
