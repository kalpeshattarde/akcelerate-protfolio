...
## Agent Rules For The real_estate_listing Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real real_estate_listing exists in code.
...
- Any attempt to present this scaffold as a finished real_estate_listing.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real real_estate_listing, add the domain model first.
