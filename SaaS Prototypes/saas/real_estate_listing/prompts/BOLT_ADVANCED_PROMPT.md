...
# BOLT Advanced Prompt - real_estate_listing

Work in this prototype root only.

## Code Truth
- The top-level real_estate_listing directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real real_estate_listing.
2. If converting, add the missing real_estate_listing data model and workflows first.
