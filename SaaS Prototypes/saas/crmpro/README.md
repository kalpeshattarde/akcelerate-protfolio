...
crmpro is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true crmpro implementation.
...
- Any domain-specific crmpro model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true crmpro domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with crmpro-specific behavior.
