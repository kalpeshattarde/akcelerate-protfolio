...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with crmpro-specific behavior.
...
- [ ] A real crmpro data model exists beyond shared scaffold entities.
- [ ] At least one true crmpro workflow is implemented end to end.
