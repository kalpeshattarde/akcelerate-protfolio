...
## Agent Rules For The crmpro Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real crmpro exists in code.
...
- Any attempt to present this scaffold as a finished crmpro.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real crmpro, add the domain model first.
