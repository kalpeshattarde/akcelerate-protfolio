...
# product_launch Prototype

product_launch is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true product_launch implementation.
...
- Any domain-specific product_launch model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true product_launch domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with product_launch-specific behavior.
