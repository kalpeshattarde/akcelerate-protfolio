...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with product_launch-specific behavior.
...
- [ ] A real product_launch data model exists beyond shared scaffold entities.
- [ ] At least one true product_launch workflow is implemented end to end.
