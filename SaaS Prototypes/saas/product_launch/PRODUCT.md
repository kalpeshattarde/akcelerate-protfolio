...
## Product Direction
- Prototype label: product_launch
- Intended product: product_launch
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a product_launch product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a product_launch product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future product_launch product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real product_launch workflow.
...
- product_launch domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true product_launch workflow.
...
### Free
- Audience: Builders evaluating the product_launch prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted product_launch workflow.
...
3. Replace one generic scaffold workflow with a real product_launch workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with product_launch-specific behavior.
