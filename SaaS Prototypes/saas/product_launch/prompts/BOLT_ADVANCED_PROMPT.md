...
# BOLT Advanced Prompt - product_launch

Work in this prototype root only.

## Code Truth
- The top-level product_launch directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real product_launch.
2. If converting, add the missing product_launch data model and workflows first.
