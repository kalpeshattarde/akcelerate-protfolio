...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with accounting-specific behavior.
...
- [ ] A real accounting data model exists beyond shared scaffold entities.
- [ ] At least one true accounting workflow is implemented end to end.
