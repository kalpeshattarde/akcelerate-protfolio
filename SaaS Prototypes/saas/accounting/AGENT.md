...
## Agent Rules For The accounting Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real accounting exists in code.
...
- Any attempt to present this scaffold as a finished accounting.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real accounting, add the domain model first.
