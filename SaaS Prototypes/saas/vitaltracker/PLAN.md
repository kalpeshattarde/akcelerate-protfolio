...
## vitaltracker Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real vitaltracker.

## Phase 2: Replace The Shared Scaffold
- Define the true vitaltracker domain model.
