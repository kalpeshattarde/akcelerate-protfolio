...
## Agent Rules For The vitaltracker Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real vitaltracker exists in code.
...
- Any attempt to present this scaffold as a finished vitaltracker.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real vitaltracker, add the domain model first.
