...
# vitaltracker Prototype

vitaltracker is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true vitaltracker implementation.
...
- Any domain-specific vitaltracker model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true vitaltracker domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with vitaltracker-specific behavior.
