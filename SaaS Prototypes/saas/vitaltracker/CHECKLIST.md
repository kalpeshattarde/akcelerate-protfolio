...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with vitaltracker-specific behavior.
...
- [ ] A real vitaltracker data model exists beyond shared scaffold entities.
- [ ] At least one true vitaltracker workflow is implemented end to end.
