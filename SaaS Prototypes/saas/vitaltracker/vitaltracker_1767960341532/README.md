...
# vitaltracker Archive - vitaltracker_1767960341532

This directory is an archived generated copy inside the vitaltracker prototype. It is not the canonical working tree for this prototype. Use the top-level `vitaltracker/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: vitaltracker
...
## How To Use It
1. Prefer the top-level `vitaltracker/README.md` for current guidance.
