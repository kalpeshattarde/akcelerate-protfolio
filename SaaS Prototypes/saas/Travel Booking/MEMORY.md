...
## Stable Context For Travel Booking
...
### Missing Domain Work
- A true Travel Booking data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Travel Booking until the code actually stops being the shared VelocityCore scaffold.
