...
## Travel Booking Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Travel Booking.

## Phase 2: Replace The Shared Scaffold
- Define the true Travel Booking domain model.
