...
# Travel Booking Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the Travel Booking prototype. It is not the canonical working tree for this prototype. Use the top-level `Travel Booking/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: Travel Booking
...
## How To Use It
1. Prefer the top-level `Travel Booking/README.md` for current guidance.
