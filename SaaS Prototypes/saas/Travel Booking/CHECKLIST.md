...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Travel Booking-specific behavior.
...
- [ ] A real Travel Booking data model exists beyond shared scaffold entities.
- [ ] At least one true Travel Booking workflow is implemented end to end.
