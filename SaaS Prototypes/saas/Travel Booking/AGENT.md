...
## Agent Rules For The Travel Booking Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Travel Booking exists in code.
...
- Any attempt to present this scaffold as a finished Travel Booking.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Travel Booking, add the domain model first.
