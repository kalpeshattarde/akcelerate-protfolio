...
Travel Booking is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Travel Booking implementation.
...
- Any domain-specific Travel Booking model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Travel Booking domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Travel Booking-specific behavior.
