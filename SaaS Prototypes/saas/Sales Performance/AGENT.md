...
## Agent Rules For The Sales Performance Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Sales Performance exists in code.
...
- Any attempt to present this scaffold as a finished Sales Performance.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Sales Performance, add the domain model first.
