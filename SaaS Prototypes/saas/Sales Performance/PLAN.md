...
## Sales Performance Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Sales Performance.

## Phase 2: Replace The Shared Scaffold
- Define the true Sales Performance domain model.
