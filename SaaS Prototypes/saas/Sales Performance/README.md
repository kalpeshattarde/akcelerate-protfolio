...
# Sales Performance Prototype

Sales Performance is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Sales Performance implementation.
...
- Any domain-specific Sales Performance model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Sales Performance domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Sales Performance-specific behavior.
