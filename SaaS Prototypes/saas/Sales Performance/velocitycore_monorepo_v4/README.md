...
# Sales Performance Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the Sales Performance prototype. It is not the canonical working tree for this prototype. Use the top-level `Sales Performance/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: Sales Performance
...
## How To Use It
1. Prefer the top-level `Sales Performance/README.md` for current guidance.
