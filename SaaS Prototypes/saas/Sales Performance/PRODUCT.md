...
- Value proposition: Provide a runnable starting point for teams exploring a Sales Performance product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Sales Performance product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Sales Performance product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Sales Performance workflow.
...
- Sales Performance domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Sales Performance workflow.
...
### Free
- Audience: Builders evaluating the Sales Performance prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Sales Performance workflow.
...
3. Replace one generic scaffold workflow with a real Sales Performance workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Sales Performance-specific behavior.
