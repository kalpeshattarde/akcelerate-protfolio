...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Sales Performance-specific behavior.
...
- [ ] A real Sales Performance data model exists beyond shared scaffold entities.
- [ ] At least one true Sales Performance workflow is implemented end to end.
