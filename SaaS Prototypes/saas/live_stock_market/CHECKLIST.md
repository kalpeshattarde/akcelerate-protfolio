...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with live_stock_market-specific behavior.
...
- [ ] A real live_stock_market data model exists beyond shared scaffold entities.
- [ ] At least one true live_stock_market workflow is implemented end to end.
