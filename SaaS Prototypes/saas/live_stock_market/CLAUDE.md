...
Use this directory as the live_stock_market prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished live_stock_market unless the code actually implements that domain.
...
2. If converting this into a true live_stock_market, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended live_stock_market direction.
