...
## Agent Rules For The live_stock_market Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real live_stock_market exists in code.
...
- Any attempt to present this scaffold as a finished live_stock_market.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real live_stock_market, add the domain model first.
