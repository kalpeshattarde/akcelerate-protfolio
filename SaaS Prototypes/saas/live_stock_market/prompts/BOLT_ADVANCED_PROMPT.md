...
# BOLT Advanced Prompt - live_stock_market

Work in this prototype root only.

## Code Truth
- The top-level live_stock_market directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real live_stock_market.
2. If converting, add the missing live_stock_market data model and workflows first.
