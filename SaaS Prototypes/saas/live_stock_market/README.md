...
# live_stock_market Prototype

live_stock_market is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true live_stock_market implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `live_stock_market_1768025603643`
...
- Any domain-specific live_stock_market model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true live_stock_market domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with live_stock_market-specific behavior.
