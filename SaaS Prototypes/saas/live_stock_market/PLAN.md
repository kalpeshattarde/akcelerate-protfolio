...
## live_stock_market Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real live_stock_market.

## Phase 2: Replace The Shared Scaffold
- Define the true live_stock_market domain model.
