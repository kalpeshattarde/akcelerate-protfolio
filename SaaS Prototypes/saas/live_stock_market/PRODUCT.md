...
## Product Direction
- Prototype label: live_stock_market
- Intended product: live_stock_market
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a live_stock_market product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a live_stock_market product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future live_stock_market product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real live_stock_market workflow.
...
- live_stock_market domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true live_stock_market workflow.
...
### Free
- Audience: Builders evaluating the live_stock_market prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted live_stock_market workflow.
...
3. Replace one generic scaffold workflow with a real live_stock_market workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with live_stock_market-specific behavior.
