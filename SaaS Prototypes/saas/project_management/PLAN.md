...
## project_management Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real project_management.

## Phase 2: Replace The Shared Scaffold
- Define the true project_management domain model.
