...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with project_management-specific behavior.
...
- [ ] A real project_management data model exists beyond shared scaffold entities.
- [ ] At least one true project_management workflow is implemented end to end.
