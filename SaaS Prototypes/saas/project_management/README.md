...
# project_management Prototype

project_management is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true project_management implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `project_management_1767955931830`
...
- Any domain-specific project_management model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true project_management domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with project_management-specific behavior.
