...
## Agent Rules For The project_management Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real project_management exists in code.
...
- Any attempt to present this scaffold as a finished project_management.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real project_management, add the domain model first.
