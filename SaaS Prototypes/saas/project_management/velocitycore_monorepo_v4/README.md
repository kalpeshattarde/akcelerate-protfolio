...
# project_management Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the project_management prototype. It is not the canonical working tree for this prototype. Use the top-level `project_management/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: project_management
...
## How To Use It
1. Prefer the top-level `project_management/README.md` for current guidance.
