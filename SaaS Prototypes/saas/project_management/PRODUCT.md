...
## Product Direction
- Prototype label: project_management
- Intended product: project_management
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a project_management product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a project_management product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future project_management product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real project_management workflow.
...
- project_management domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true project_management workflow.
...
### Free
- Audience: Builders evaluating the project_management prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted project_management workflow.
...
3. Replace one generic scaffold workflow with a real project_management workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with project_management-specific behavior.
