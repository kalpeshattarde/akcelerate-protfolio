...
class AppTheme {
  ...
  static const Color errorLight =
      Color(0xFFFF6B6B); // Warm coral (same as accent)
  ...
  static const Color successDark =
      Color(0xFF38A169); // Natural green (maintained)
  static const Color warningDark =
      Color(0xFFED8936); // Gentle orange (maintained)
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    final Color textLowEmphasis =
        isLight ? textTertiaryLight : textTertiaryDark;
