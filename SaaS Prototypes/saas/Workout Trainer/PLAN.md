...
## Workout Trainer Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Workout Trainer.

## Phase 2: Replace The Shared Scaffold
- Define the true Workout Trainer domain model.
