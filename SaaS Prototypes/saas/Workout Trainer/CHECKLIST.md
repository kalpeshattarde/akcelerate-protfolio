...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Workout Trainer-specific behavior.
...
- [ ] A real Workout Trainer data model exists beyond shared scaffold entities.
- [ ] At least one true Workout Trainer workflow is implemented end to end.
