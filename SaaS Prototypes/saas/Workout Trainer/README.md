...
# Workout Trainer Prototype

Workout Trainer is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Workout Trainer implementation.
...
- Any domain-specific Workout Trainer model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Workout Trainer domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Workout Trainer-specific behavior.
