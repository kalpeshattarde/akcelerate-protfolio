...
# BOLT Advanced Prompt - Workout Trainer

Work in this prototype root only.

## Code Truth
- The top-level Workout Trainer directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real Workout Trainer.
2. If converting, add the missing Workout Trainer data model and workflows first.
