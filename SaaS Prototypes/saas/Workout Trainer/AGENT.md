...
## Agent Rules For The Workout Trainer Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Workout Trainer exists in code.
...
- Any attempt to present this scaffold as a finished Workout Trainer.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Workout Trainer, add the domain model first.
