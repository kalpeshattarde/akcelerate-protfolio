...
## Agent Rules For The mobileapp_download Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real mobileapp_download exists in code.
...
- Any attempt to present this scaffold as a finished mobileapp_download.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real mobileapp_download, add the domain model first.
