...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with mobileapp_download-specific behavior.
...
- [ ] A real mobileapp_download data model exists beyond shared scaffold entities.
- [ ] At least one true mobileapp_download workflow is implemented end to end.
