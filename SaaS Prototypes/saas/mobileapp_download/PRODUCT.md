...
## Product Direction
- Prototype label: mobileapp_download
- Intended product: mobileapp_download
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a mobileapp_download product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a mobileapp_download product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future mobileapp_download product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real mobileapp_download workflow.
...
- mobileapp_download domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true mobileapp_download workflow.
...
### Free
- Audience: Builders evaluating the mobileapp_download prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted mobileapp_download workflow.
...
3. Replace one generic scaffold workflow with a real mobileapp_download workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with mobileapp_download-specific behavior.
