...
## mobileapp_download Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real mobileapp_download.

## Phase 2: Replace The Shared Scaffold
- Define the true mobileapp_download domain model.
