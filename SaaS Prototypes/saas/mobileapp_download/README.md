...
# mobileapp_download Prototype

mobileapp_download is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true mobileapp_download implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `mobileapp_showcase_1768023829294`
...
- Any domain-specific mobileapp_download model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true mobileapp_download domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with mobileapp_download-specific behavior.
