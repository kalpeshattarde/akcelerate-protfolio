...
# BOLT Advanced Prompt - mobileapp_download

Work in this prototype root only.

## Code Truth
- The top-level mobileapp_download directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real mobileapp_download.
2. If converting, add the missing mobileapp_download data model and workflows first.
