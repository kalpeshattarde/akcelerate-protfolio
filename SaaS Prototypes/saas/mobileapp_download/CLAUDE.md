...
Use this directory as the mobileapp_download prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished mobileapp_download unless the code actually implements that domain.
...
2. If converting this into a true mobileapp_download, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended mobileapp_download direction.
