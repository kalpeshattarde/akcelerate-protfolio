...
## Stable Context For mobileapp_download
...
### Missing Domain Work
- A true mobileapp_download data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished mobileapp_download until the code actually stops being the shared VelocityCore scaffold.
