...
## Stable Context For Pregnancy Tracker
...
### Missing Domain Work
- A true Pregnancy Tracker data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Pregnancy Tracker until the code actually stops being the shared VelocityCore scaffold.
