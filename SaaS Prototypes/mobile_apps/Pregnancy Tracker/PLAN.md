...
## Pregnancy Tracker Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Pregnancy Tracker.

## Phase 2: Replace The Shared Scaffold
- Define the true Pregnancy Tracker domain model.
