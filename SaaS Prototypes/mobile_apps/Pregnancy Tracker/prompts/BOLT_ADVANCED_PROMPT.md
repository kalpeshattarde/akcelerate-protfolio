...
# BOLT Advanced Prompt - Pregnancy Tracker

Work in this prototype root only.

## Code Truth
- The top-level Pregnancy Tracker directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real Pregnancy Tracker.
2. If converting, add the missing Pregnancy Tracker data model and workflows first.
