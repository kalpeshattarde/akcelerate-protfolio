...
## Product Direction
- Prototype label: Pregnancy Tracker
...
## Personas
- Founder or product lead validating a future Pregnancy Tracker product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Pregnancy Tracker workflow.
...
- Pregnancy Tracker domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Pregnancy Tracker workflow.
...
### Free
- Audience: Builders evaluating the Pregnancy Tracker prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Pregnancy Tracker workflow.
...
3. Replace one generic scaffold workflow with a real Pregnancy Tracker workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Pregnancy Tracker-specific behavior.
