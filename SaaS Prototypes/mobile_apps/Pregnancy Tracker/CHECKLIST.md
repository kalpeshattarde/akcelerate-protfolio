...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Pregnancy Tracker-specific behavior.
...
- [ ] A real Pregnancy Tracker data model exists beyond shared scaffold entities.
- [ ] At least one true Pregnancy Tracker workflow is implemented end to end.
