...
## Agent Rules For The Pregnancy Tracker Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Pregnancy Tracker exists in code.
...
- Any attempt to present this scaffold as a finished Pregnancy Tracker.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Pregnancy Tracker, add the domain model first.
