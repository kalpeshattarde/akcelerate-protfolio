...
Use this directory as the pharmacy_inventory prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished pharmacy_inventory unless the code actually implements that domain.
...
2. If converting this into a true pharmacy_inventory, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended pharmacy_inventory direction.
