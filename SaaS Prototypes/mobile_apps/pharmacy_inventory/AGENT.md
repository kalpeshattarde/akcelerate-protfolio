...
## Agent Rules For The pharmacy_inventory Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real pharmacy_inventory exists in code.
...
- Any attempt to present this scaffold as a finished pharmacy_inventory.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real pharmacy_inventory, add the domain model first.
