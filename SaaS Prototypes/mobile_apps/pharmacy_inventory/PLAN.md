...
## pharmacy_inventory Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real pharmacy_inventory.

## Phase 2: Replace The Shared Scaffold
- Define the true pharmacy_inventory domain model.
