...
# pharmacy_inventory Prototype

pharmacy_inventory is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true pharmacy_inventory implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `pharmacy_inventory_1767969668171`
...
- Any domain-specific pharmacy_inventory model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true pharmacy_inventory domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with pharmacy_inventory-specific behavior.
