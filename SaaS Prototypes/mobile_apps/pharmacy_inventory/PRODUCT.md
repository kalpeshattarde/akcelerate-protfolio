...
## Product Direction
- Prototype label: pharmacy_inventory
- Intended product: pharmacy_inventory
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a pharmacy_inventory product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a pharmacy_inventory product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future pharmacy_inventory product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real pharmacy_inventory workflow.
...
- pharmacy_inventory domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true pharmacy_inventory workflow.
...
### Free
- Audience: Builders evaluating the pharmacy_inventory prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted pharmacy_inventory workflow.
...
3. Replace one generic scaffold workflow with a real pharmacy_inventory workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with pharmacy_inventory-specific behavior.
