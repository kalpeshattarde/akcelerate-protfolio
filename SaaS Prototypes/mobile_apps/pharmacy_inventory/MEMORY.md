...
## Stable Context For pharmacy_inventory
...
### Missing Domain Work
- A true pharmacy_inventory data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished pharmacy_inventory until the code actually stops being the shared VelocityCore scaffold.
