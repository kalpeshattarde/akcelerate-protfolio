...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with pharmacy_inventory-specific behavior.
...
- [ ] A real pharmacy_inventory data model exists beyond shared scaffold entities.
- [ ] At least one true pharmacy_inventory workflow is implemented end to end.
