...
# BOLT Advanced Prompt - pharmacy_inventory

Work in this prototype root only.

## Code Truth
- The top-level pharmacy_inventory directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real pharmacy_inventory.
2. If converting, add the missing pharmacy_inventory data model and workflows first.
