...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Podcast Player-specific behavior.
...
- [ ] A real Podcast Player data model exists beyond shared scaffold entities.
- [ ] At least one true Podcast Player workflow is implemented end to end.
