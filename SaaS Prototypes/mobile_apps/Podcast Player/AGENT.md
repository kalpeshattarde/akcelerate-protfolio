...
## Agent Rules For The Podcast Player Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Podcast Player exists in code.
...
- Any attempt to present this scaffold as a finished Podcast Player.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Podcast Player, add the domain model first.
