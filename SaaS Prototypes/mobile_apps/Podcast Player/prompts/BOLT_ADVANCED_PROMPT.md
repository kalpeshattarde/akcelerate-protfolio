...
# BOLT Advanced Prompt - Podcast Player

Work in this prototype root only.

## Code Truth
- The top-level Podcast Player directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real Podcast Player.
2. If converting, add the missing Podcast Player data model and workflows first.
