...
# Podcast Player Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the Podcast Player prototype. It is not the canonical working tree for this prototype. Use the top-level `Podcast Player/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: Podcast Player
...
## How To Use It
1. Prefer the top-level `Podcast Player/README.md` for current guidance.
