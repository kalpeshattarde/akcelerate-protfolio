...
## Stable Context For event_registration
...
### Missing Domain Work
- A true event_registration data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished event_registration until the code actually stops being the shared VelocityCore scaffold.
