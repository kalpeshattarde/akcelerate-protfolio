...
## Agent Rules For The event_registration Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real event_registration exists in code.
...
- Any attempt to present this scaffold as a finished event_registration.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real event_registration, add the domain model first.
