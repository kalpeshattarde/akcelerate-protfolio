...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with event_registration-specific behavior.
...
- [ ] A real event_registration data model exists beyond shared scaffold entities.
- [ ] At least one true event_registration workflow is implemented end to end.
