...
# event_registration Prototype

event_registration is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true event_registration implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `event_registration_1768024458403`
...
- Any domain-specific event_registration model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true event_registration domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with event_registration-specific behavior.
