...
## event_registration Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real event_registration.

## Phase 2: Replace The Shared Scaffold
- Define the true event_registration domain model.
