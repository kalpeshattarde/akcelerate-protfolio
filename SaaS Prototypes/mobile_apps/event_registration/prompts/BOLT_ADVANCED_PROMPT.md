...
# BOLT Advanced Prompt - event_registration

Work in this prototype root only.

## Code Truth
- The top-level event_registration directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real event_registration.
2. If converting, add the missing event_registration data model and workflows first.
