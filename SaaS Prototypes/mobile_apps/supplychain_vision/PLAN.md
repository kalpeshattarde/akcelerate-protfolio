...
## supplychain_vision Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real supplychain_vision.

## Phase 2: Replace The Shared Scaffold
- Define the true supplychain_vision domain model.
