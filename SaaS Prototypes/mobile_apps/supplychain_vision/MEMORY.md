...
## Stable Context For supplychain_vision
...
### Missing Domain Work
- A true supplychain_vision data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished supplychain_vision until the code actually stops being the shared VelocityCore scaffold.
