...
Use this directory as the supplychain_vision prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished supplychain_vision unless the code actually implements that domain.
...
2. If converting this into a true supplychain_vision, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended supplychain_vision direction.
