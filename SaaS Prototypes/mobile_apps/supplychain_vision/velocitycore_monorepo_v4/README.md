...
# supplychain_vision Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the supplychain_vision prototype. It is not the canonical working tree for this prototype. Use the top-level `supplychain_vision/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: supplychain_vision
...
## How To Use It
1. Prefer the top-level `supplychain_vision/README.md` for current guidance.
