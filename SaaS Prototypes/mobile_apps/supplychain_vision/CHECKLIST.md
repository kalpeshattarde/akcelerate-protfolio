...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with supplychain_vision-specific behavior.
...
- [ ] A real supplychain_vision data model exists beyond shared scaffold entities.
- [ ] At least one true supplychain_vision workflow is implemented end to end.
