...
# supplychain_vision Prototype

supplychain_vision is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true supplychain_vision implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `supplychain_vision_1767968858395`
...
- Any domain-specific supplychain_vision model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true supplychain_vision domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with supplychain_vision-specific behavior.
