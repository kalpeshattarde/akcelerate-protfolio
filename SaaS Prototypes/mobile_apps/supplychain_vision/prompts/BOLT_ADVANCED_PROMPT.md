...
# BOLT Advanced Prompt - supplychain_vision

Work in this prototype root only.

## Code Truth
- The top-level supplychain_vision directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real supplychain_vision.
2. If converting, add the missing supplychain_vision data model and workflows first.
