...
## Product Direction
- Prototype label: supplychain_vision
- Intended product: supplychain_vision
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a supplychain_vision product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a supplychain_vision product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future supplychain_vision product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real supplychain_vision workflow.
...
- supplychain_vision domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true supplychain_vision workflow.
...
### Free
- Audience: Builders evaluating the supplychain_vision prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted supplychain_vision workflow.
...
3. Replace one generic scaffold workflow with a real supplychain_vision workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with supplychain_vision-specific behavior.
