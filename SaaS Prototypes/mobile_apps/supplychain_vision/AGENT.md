...
## Agent Rules For The supplychain_vision Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real supplychain_vision exists in code.
...
- Any attempt to present this scaffold as a finished supplychain_vision.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real supplychain_vision, add the domain model first.
