...
# BOLT Advanced Prompt - guided_breathing

Work in this prototype root only.

## Code Truth
- The top-level guided_breathing directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real guided_breathing.
2. If converting, add the missing guided_breathing data model and workflows first.
