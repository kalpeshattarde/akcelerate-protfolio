...
# guided_breathing Prototype

guided_breathing is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true guided_breathing implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `guided_breathing_1767964023309`
...
- Any domain-specific guided_breathing model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true guided_breathing domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with guided_breathing-specific behavior.
