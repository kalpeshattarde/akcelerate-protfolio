...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with guided_breathing-specific behavior.
...
- [ ] A real guided_breathing data model exists beyond shared scaffold entities.
- [ ] At least one true guided_breathing workflow is implemented end to end.
