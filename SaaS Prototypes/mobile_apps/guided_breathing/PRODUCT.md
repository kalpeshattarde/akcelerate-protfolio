...
## Product Direction
- Prototype label: guided_breathing
- Intended product: guided_breathing
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a guided_breathing product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a guided_breathing product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future guided_breathing product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real guided_breathing workflow.
...
- guided_breathing domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true guided_breathing workflow.
...
### Free
- Audience: Builders evaluating the guided_breathing prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted guided_breathing workflow.
...
3. Replace one generic scaffold workflow with a real guided_breathing workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with guided_breathing-specific behavior.
