...
## Stable Context For guided_breathing
...
### Missing Domain Work
- A true guided_breathing data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished guided_breathing until the code actually stops being the shared VelocityCore scaffold.
