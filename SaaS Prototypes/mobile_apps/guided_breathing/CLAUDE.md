...
Use this directory as the guided_breathing prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished guided_breathing unless the code actually implements that domain.
...
2. If converting this into a true guided_breathing, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended guided_breathing direction.
