...
## guided_breathing Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real guided_breathing.

## Phase 2: Replace The Shared Scaffold
- Define the true guided_breathing domain model.
