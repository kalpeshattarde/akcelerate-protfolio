  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://images.unsplash.com/photo-1704151598190-1a5f411af6b6"
          alt="Diverse group of people sitting around a wooden dining table enjoying various Mediterranean dishes together in a warm, social atmosphere"
        ...
        <div className="flex flex-col items-center justify-center text-center" style={{ minHeight: 'calc(100vh - 8rem)', paddingTop: '4rem', paddingBottom: '8rem' }}>
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-orange-100 font-medium mb-6 drop-shadow-md">
              Get <span className="text-orange-400 font-bold text-2xl sm:text-3xl">25% OFF</span> your first order + 
            ...
            <p className="text-lg text-orange-200 mt-4 font-medium">
              *Limited time offer - Use code: <span className="text-orange-400 font-bold">GOLDEN25</span>
            </p>
          </motion.div>
          ...
          >
            ...
            <Button
              ...
              size="lg"
              onClick={onOrderNow}
              className="text-xl px-10 py-5 border-2 border-white text-white hover:bg-white hover:text-black font-bold rounded-lg shadow-2xl hover:scale-105 transition-all duration-300"
            >
              Order Online
            </Button>
          </motion.div>
