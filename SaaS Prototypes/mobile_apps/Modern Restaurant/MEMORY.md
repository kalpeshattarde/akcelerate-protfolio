...
## Stable Context For Modern Restaurant
...
### Missing Domain Work
- A true Modern Restaurant data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Modern Restaurant until the code actually stops being the shared VelocityCore scaffold.
