...
# Modern Restaurant Prototype

Modern Restaurant is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Modern Restaurant implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `pesto_restaurant_web_app_1767962403452`
...
- Any domain-specific Modern Restaurant model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Modern Restaurant domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Modern Restaurant-specific behavior.
