...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Modern Restaurant-specific behavior.
...
- [ ] A real Modern Restaurant data model exists beyond shared scaffold entities.
- [ ] At least one true Modern Restaurant workflow is implemented end to end.
