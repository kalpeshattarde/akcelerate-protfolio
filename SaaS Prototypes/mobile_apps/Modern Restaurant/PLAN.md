...
## Modern Restaurant Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Modern Restaurant.

## Phase 2: Replace The Shared Scaffold
- Define the true Modern Restaurant domain model.
