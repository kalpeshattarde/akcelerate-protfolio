...
## Product Direction
- Prototype label: Modern Restaurant
- Intended product: Modern Restaurant
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a Modern Restaurant product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Modern Restaurant product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Modern Restaurant product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Modern Restaurant workflow.
...
- Modern Restaurant domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Modern Restaurant workflow.
...
### Free
- Audience: Builders evaluating the Modern Restaurant prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Modern Restaurant workflow.
...
3. Replace one generic scaffold workflow with a real Modern Restaurant workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Modern Restaurant-specific behavior.
