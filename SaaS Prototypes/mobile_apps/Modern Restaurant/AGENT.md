...
## Agent Rules For The Modern Restaurant Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Modern Restaurant exists in code.
...
- Any attempt to present this scaffold as a finished Modern Restaurant.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Modern Restaurant, add the domain model first.
