...
## Agent Rules For The Video Editing Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Video Editing exists in code.
...
- Any attempt to present this scaffold as a finished Video Editing.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Video Editing, add the domain model first.
