...
## Product Direction
- Prototype label: Video Editing
- Intended product: Video Editing
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a Video Editing product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Video Editing product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Video Editing product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Video Editing workflow.
...
- Video Editing domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Video Editing workflow.
...
### Free
- Audience: Builders evaluating the Video Editing prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Video Editing workflow.
...
3. Replace one generic scaffold workflow with a real Video Editing workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Video Editing-specific behavior.
