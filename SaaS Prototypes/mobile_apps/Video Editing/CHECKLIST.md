...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Video Editing-specific behavior.
...
- [ ] A real Video Editing data model exists beyond shared scaffold entities.
- [ ] At least one true Video Editing workflow is implemented end to end.
