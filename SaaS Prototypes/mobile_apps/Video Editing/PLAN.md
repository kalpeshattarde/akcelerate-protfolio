...
## Video Editing Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Video Editing.

## Phase 2: Replace The Shared Scaffold
- Define the true Video Editing domain model.
