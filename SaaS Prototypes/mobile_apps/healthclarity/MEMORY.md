...
## Stable Context For healthclarity
...
### Missing Domain Work
- A true healthclarity data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished healthclarity until the code actually stops being the shared VelocityCore scaffold.
