...
## Agent Rules For The healthclarity Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real healthclarity exists in code.
...
- Any attempt to present this scaffold as a finished healthclarity.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real healthclarity, add the domain model first.
