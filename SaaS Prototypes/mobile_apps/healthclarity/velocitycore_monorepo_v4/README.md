...
# healthclarity Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the healthclarity prototype. It is not the canonical working tree for this prototype. Use the top-level `healthclarity/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: healthclarity
...
## How To Use It
1. Prefer the top-level `healthclarity/README.md` for current guidance.
