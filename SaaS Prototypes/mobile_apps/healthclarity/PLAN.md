...
## healthclarity Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real healthclarity.

## Phase 2: Replace The Shared Scaffold
- Define the true healthclarity domain model.
