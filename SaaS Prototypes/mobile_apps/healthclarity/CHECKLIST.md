...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with healthclarity-specific behavior.
...
- [ ] A real healthclarity data model exists beyond shared scaffold entities.
- [ ] At least one true healthclarity workflow is implemented end to end.
