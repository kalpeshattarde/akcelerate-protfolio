...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with language_learning-specific behavior.
...
- [ ] A real language_learning data model exists beyond shared scaffold entities.
- [ ] At least one true language_learning workflow is implemented end to end.
