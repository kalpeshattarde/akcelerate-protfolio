...
# BOLT Advanced Prompt - language_learning

Work in this prototype root only.

## Code Truth
- The top-level language_learning directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real language_learning.
2. If converting, add the missing language_learning data model and workflows first.
