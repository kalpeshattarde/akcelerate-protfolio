...
# language_learning Prototype

language_learning is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true language_learning implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `language_learning_1767964640909`
...
- Any domain-specific language_learning model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true language_learning domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with language_learning-specific behavior.
