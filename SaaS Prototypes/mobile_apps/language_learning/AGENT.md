...
## Agent Rules For The language_learning Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real language_learning exists in code.
...
- Any attempt to present this scaffold as a finished language_learning.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real language_learning, add the domain model first.
