...
## Stable Context For language_learning
...
### Missing Domain Work
- A true language_learning data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished language_learning until the code actually stops being the shared VelocityCore scaffold.
