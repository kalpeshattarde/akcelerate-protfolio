...
## Product Direction
- Prototype label: language_learning
- Intended product: language_learning
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a language_learning product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a language_learning product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future language_learning product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real language_learning workflow.
...
- language_learning domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true language_learning workflow.
...
### Free
- Audience: Builders evaluating the language_learning prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted language_learning workflow.
...
3. Replace one generic scaffold workflow with a real language_learning workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with language_learning-specific behavior.
