...
Use this directory as the language_learning prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished language_learning unless the code actually implements that domain.
...
2. If converting this into a true language_learning, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended language_learning direction.
