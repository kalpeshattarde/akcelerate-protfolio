...
## language_learning Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real language_learning.

## Phase 2: Replace The Shared Scaffold
- Define the true language_learning domain model.
