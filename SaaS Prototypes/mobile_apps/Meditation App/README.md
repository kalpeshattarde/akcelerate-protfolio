...
Meditation App is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Meditation App implementation.
...
- Archive paths:
  ...
  - `zenith_meditation_1767965160186`
...
- Any domain-specific Meditation App model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Meditation App domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Meditation App-specific behavior.
