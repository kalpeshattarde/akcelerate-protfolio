...
## Agent Rules For The Meditation App Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Meditation App exists in code.
...
- Any attempt to present this scaffold as a finished Meditation App.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Meditation App, add the domain model first.
