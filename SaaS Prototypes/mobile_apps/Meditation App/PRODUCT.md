...
## Product Direction
- Prototype label: Meditation App
- Intended product: Meditation App
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a Meditation App product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Meditation App product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Meditation App product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Meditation App workflow.
...
- Meditation App domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Meditation App workflow.
...
### Free
- Audience: Builders evaluating the Meditation App prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Meditation App workflow.
...
3. Replace one generic scaffold workflow with a real Meditation App workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Meditation App-specific behavior.
