...
## Agent Rules For The to_do_list Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real to_do_list exists in code.
...
- Any attempt to present this scaffold as a finished to_do_list.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real to_do_list, add the domain model first.
