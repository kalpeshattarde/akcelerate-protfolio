...
# to_do_list Prototype

to_do_list is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true to_do_list implementation.
...
- Any domain-specific to_do_list model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true to_do_list domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with to_do_list-specific behavior.
