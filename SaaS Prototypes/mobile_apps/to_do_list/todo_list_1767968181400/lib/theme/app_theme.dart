...
/// Implements Contemporary Productive Minimalism design approach with
/// Adaptive Focus Palette optimized for task management workflows.
class AppTheme {
  AppTheme._();

  // Adaptive Focus Palette - Color specifications
  static const Color primaryLight = Color(0xFF2563EB); // Deep blue
  ...
  static const Color successLight = Color(0xFF059669); // Vibrant green
  ...
  static const Color backgroundDark =
      Color(0xFF020617); // Deeper slate background

  static const Color textPrimaryLight = Color(0xFF1E293B); // Near-black
  static const Color textPrimaryDark = Color(0xFFF1F5F9); // Near-white
  static const Color textSecondaryLight = Color(0xFF64748B); // Medium gray
  static const Color textSecondaryDark =
      Color(0xFF94A3B8); // Lighter gray for dark theme

  static const Color accentLight = Color(0xFF8B5CF6); // Purple accent
  ...
  // Shadow and divider colors with subtle opacity
  static const Color shadowLight =
      Color(0x0A000000); // 0.04 opacity for subtle depth
  static const Color shadowDark =
      Color(0x14FFFFFF); // 0.08 opacity for dark theme
  ...
  static const Color textHighEmphasisLight = Color(0xDE1E293B); // 87% opacity
  static const Color textMediumEmphasisLight = Color(0x9964748B); // 60% opacity
  static const Color textDisabledLight = Color(0x6164748B); // 38% opacity

  static const Color textHighEmphasisDark = Color(0xDEF1F5F9); // 87% opacity
  static const Color textMediumEmphasisDark = Color(0x9994A3B8); // 60% opacity
  static const Color textDisabledDark = Color(0x6194A3B8); // 38% opacity

  /// Light theme implementing Contemporary Productive Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme with contextual transitions support
    ...
    // FAB with gradient implementation (single subtle gradient)
  ...
  /// Dark theme implementing Contemporary Productive Minimalism
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles - Inter 500/600 for card titles and labels
      ...
      // Body styles - Inter 400/500 for main content
  ...
  /// Used for numerical data, dates, and times
