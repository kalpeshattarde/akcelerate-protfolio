...
# BOLT Advanced Prompt - to_do_list

Work in this prototype root only.

## Code Truth
- The top-level to_do_list directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real to_do_list.
2. If converting, add the missing to_do_list data model and workflows first.
