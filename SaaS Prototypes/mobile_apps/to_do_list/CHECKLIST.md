...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with to_do_list-specific behavior.
...
- [ ] A real to_do_list data model exists beyond shared scaffold entities.
- [ ] At least one true to_do_list workflow is implemented end to end.
