...
Use this directory as the to_do_list prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished to_do_list unless the code actually implements that domain.
...
2. If converting this into a true to_do_list, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended to_do_list direction.
