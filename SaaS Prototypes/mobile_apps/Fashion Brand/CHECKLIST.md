...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Fashion Brand-specific behavior.
...
- [ ] A real Fashion Brand data model exists beyond shared scaffold entities.
- [ ] At least one true Fashion Brand workflow is implemented end to end.
