...
## Agent Rules For The Fashion Brand Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Fashion Brand exists in code.
...
- Any attempt to present this scaffold as a finished Fashion Brand.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Fashion Brand, add the domain model first.
