...
## Stable Context For Fashion Brand
...
### Missing Domain Work
- A true Fashion Brand data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Fashion Brand until the code actually stops being the shared VelocityCore scaffold.
