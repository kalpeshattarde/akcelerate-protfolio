...
Use this directory as the pet_care prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished pet_care unless the code actually implements that domain.
...
2. If converting this into a true pet_care, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended pet_care direction.
