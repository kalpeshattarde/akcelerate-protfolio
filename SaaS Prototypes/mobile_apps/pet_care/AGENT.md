...
## Agent Rules For The pet_care Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real pet_care exists in code.
...
- Any attempt to present this scaffold as a finished pet_care.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real pet_care, add the domain model first.
