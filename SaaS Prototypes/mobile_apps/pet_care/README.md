...
pet_care is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true pet_care implementation.
...
- Any domain-specific pet_care model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true pet_care domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with pet_care-specific behavior.
