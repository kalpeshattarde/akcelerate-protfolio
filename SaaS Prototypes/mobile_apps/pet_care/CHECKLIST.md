...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with pet_care-specific behavior.
...
- [ ] A real pet_care data model exists beyond shared scaffold entities.
- [ ] At least one true pet_care workflow is implemented end to end.
