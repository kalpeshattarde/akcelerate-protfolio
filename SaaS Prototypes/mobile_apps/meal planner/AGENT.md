...
## Agent Rules For The meal planner Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real meal planner exists in code.
...
- Any attempt to present this scaffold as a finished meal planner.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real meal planner, add the domain model first.
