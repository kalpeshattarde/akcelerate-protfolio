...
## Stable Context For meal planner
...
### Missing Domain Work
- A true meal planner data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished meal planner until the code actually stops being the shared VelocityCore scaffold.
