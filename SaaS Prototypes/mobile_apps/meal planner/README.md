...
meal planner is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true meal planner implementation.
...
- Any domain-specific meal planner model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true meal planner domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with meal planner-specific behavior.
