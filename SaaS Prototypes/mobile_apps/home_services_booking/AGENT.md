...
## Agent Rules For The home_services_booking Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real home_services_booking exists in code.
...
- Any attempt to present this scaffold as a finished home_services_booking.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real home_services_booking, add the domain model first.
