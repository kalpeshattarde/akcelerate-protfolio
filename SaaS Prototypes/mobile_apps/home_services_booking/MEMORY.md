...
## Stable Context For home_services_booking
...
### Missing Domain Work
- A true home_services_booking data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished home_services_booking until the code actually stops being the shared VelocityCore scaffold.
