...
## Product Direction
- Prototype label: home_services_booking
- Intended product: home_services_booking
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a home_services_booking product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a home_services_booking product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future home_services_booking product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real home_services_booking workflow.
...
- home_services_booking domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true home_services_booking workflow.
...
### Free
- Audience: Builders evaluating the home_services_booking prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted home_services_booking workflow.
...
3. Replace one generic scaffold workflow with a real home_services_booking workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with home_services_booking-specific behavior.
