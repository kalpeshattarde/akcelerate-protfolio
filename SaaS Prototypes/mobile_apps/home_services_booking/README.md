...
# home_services_booking Prototype

home_services_booking is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true home_services_booking implementation.
...
- Canonical code paths:
  ...
  - `packages/types`
- Archive paths:
  - `home_services_booking_1767964437652`
...
- Any domain-specific home_services_booking model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true home_services_booking domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with home_services_booking-specific behavior.
