...
# BOLT Advanced Prompt - home_services_booking

Work in this prototype root only.

## Code Truth
- The top-level home_services_booking directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real home_services_booking.
2. If converting, add the missing home_services_booking data model and workflows first.
