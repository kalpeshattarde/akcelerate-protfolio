...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with home_services_booking-specific behavior.
...
- [ ] A real home_services_booking data model exists beyond shared scaffold entities.
- [ ] At least one true home_services_booking workflow is implemented end to end.
