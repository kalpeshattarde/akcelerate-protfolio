...
# home_services_booking Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the home_services_booking prototype. It is not the canonical working tree for this prototype. Use the top-level `home_services_booking/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: home_services_booking
...
## How To Use It
1. Prefer the top-level `home_services_booking/README.md` for current guidance.
