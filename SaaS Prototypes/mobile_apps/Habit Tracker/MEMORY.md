...
## Stable Context For Habit Tracker
...
### Missing Domain Work
- A true Habit Tracker data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Habit Tracker until the code actually stops being the shared VelocityCore scaffold.
