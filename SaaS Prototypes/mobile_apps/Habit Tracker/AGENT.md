...
## Agent Rules For The Habit Tracker Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Habit Tracker exists in code.
...
- Any attempt to present this scaffold as a finished Habit Tracker.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Habit Tracker, add the domain model first.
