...
Habit Tracker is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Habit Tracker implementation.
...
- Any domain-specific Habit Tracker model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Habit Tracker domain model and workflow set.
