...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Services - FlowTech Studio | Technology with Soul</title>
        <meta 
          name="description" 
          content="Discover FlowTech Studio's comprehensive digital solutions. From React 18+ development to enterprise-grade applications, we craft technology experiences that matter. Get your custom quote today." 
        />
        ...
        <meta property="og:title" content="Services - FlowTech Studio | Technology with Soul" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-200">
                  <li>hello@flowtechstudio.com</li>
            ...
            <div className="border-t border-white/20 mt-8 pt-8 text-center text-gray-200">
              <p>&copy; {new Date()?.getFullYear()} FlowTech Studio. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
