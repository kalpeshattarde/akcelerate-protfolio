...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with tech startup-specific behavior.
...
- [ ] A real tech startup data model exists beyond shared scaffold entities.
- [ ] At least one true tech startup workflow is implemented end to end.
