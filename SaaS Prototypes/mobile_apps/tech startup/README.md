...
# tech startup Prototype

tech startup is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true tech startup implementation.
...
- Any domain-specific tech startup model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true tech startup domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with tech startup-specific behavior.
