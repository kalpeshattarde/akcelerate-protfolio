...
## Agent Rules For The tech startup Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real tech startup exists in code.
...
- Any attempt to present this scaffold as a finished tech startup.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real tech startup, add the domain model first.
