...
## Product Direction
- Prototype label: tech startup
- Intended product: tech startup
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a tech startup product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a tech startup product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future tech startup product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real tech startup workflow.
...
- tech startup domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true tech startup workflow.
...
### Free
- Audience: Builders evaluating the tech startup prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted tech startup workflow.
...
3. Replace one generic scaffold workflow with a real tech startup workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with tech startup-specific behavior.
