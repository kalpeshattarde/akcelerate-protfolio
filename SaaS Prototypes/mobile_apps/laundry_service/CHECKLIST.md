...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with laundry_service-specific behavior.
...
- [ ] A real laundry_service data model exists beyond shared scaffold entities.
- [ ] At least one true laundry_service workflow is implemented end to end.
