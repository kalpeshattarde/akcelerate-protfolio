...
## laundry_service Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real laundry_service.

## Phase 2: Replace The Shared Scaffold
- Define the true laundry_service domain model.
