...
## Product Direction
- Prototype label: laundry_service
- Intended product: laundry_service
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a laundry_service product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a laundry_service product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future laundry_service product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real laundry_service workflow.
...
- laundry_service domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true laundry_service workflow.
...
### Free
- Audience: Builders evaluating the laundry_service prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted laundry_service workflow.
...
3. Replace one generic scaffold workflow with a real laundry_service workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with laundry_service-specific behavior.
