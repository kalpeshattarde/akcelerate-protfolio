...
## Agent Rules For The laundry_service Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real laundry_service exists in code.
...
- Any attempt to present this scaffold as a finished laundry_service.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real laundry_service, add the domain model first.
