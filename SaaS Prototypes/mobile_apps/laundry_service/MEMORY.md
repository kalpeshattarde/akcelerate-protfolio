...
## Stable Context For laundry_service
...
### Missing Domain Work
- A true laundry_service data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished laundry_service until the code actually stops being the shared VelocityCore scaffold.
