...
# laundry_service Prototype

laundry_service is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true laundry_service implementation.
...
- Any domain-specific laundry_service model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true laundry_service domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with laundry_service-specific behavior.
