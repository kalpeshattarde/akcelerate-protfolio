...
# laundry_service Archive - velocitycore_monorepo_v4

This directory is an archived generated copy inside the laundry_service prototype. It is not the canonical working tree for this prototype. Use the top-level `laundry_service/` directory as the primary source of truth unless you are intentionally reviving this archive.

## Archive Type
- Type: VelocityCore monorepo archive
- Intended product direction: laundry_service
...
## How To Use It
1. Prefer the top-level `laundry_service/README.md` for current guidance.
