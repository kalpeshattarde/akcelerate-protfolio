...
# Digital Agency Prototype

Digital Agency is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true Digital Agency implementation.
...
- Any domain-specific Digital Agency model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true Digital Agency domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with Digital Agency-specific behavior.
