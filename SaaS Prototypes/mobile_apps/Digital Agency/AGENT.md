...
## Agent Rules For The Digital Agency Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Digital Agency exists in code.
...
- Any attempt to present this scaffold as a finished Digital Agency.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Digital Agency, add the domain model first.
