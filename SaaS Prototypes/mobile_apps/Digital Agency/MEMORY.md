...
## Stable Context For Digital Agency
...
### Missing Domain Work
- A true Digital Agency data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished Digital Agency until the code actually stops being the shared VelocityCore scaffold.
