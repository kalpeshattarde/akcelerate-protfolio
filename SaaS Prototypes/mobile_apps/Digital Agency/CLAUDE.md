...
Use this directory as the Digital Agency prototype root.

## Repo Truth
- The active code in this directory is still the shared VelocityCore customer-operations scaffold.
- Do not describe this as a finished Digital Agency unless the code actually implements that domain.
...
2. If converting this into a true Digital Agency, replace the generic customer-operations assumptions before adding surface-level polish.
...
- Clear separation of current scaffold versus intended Digital Agency direction.
