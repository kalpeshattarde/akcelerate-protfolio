...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Digital Agency-specific behavior.
...
- [ ] A real Digital Agency data model exists beyond shared scaffold entities.
- [ ] At least one true Digital Agency workflow is implemented end to end.
