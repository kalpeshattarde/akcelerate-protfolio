...
## Product Direction
- Prototype label: Digital Agency
- Intended product: Digital Agency
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a Digital Agency product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Digital Agency product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Digital Agency product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Digital Agency workflow.
...
- Digital Agency domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Digital Agency workflow.
...
### Free
- Audience: Builders evaluating the Digital Agency prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Digital Agency workflow.
...
3. Replace one generic scaffold workflow with a real Digital Agency workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Digital Agency-specific behavior.
