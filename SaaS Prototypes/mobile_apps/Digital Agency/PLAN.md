...
## Digital Agency Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Digital Agency.

## Phase 2: Replace The Shared Scaffold
- Define the true Digital Agency domain model.
