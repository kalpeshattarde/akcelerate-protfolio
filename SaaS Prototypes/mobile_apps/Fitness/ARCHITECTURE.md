...
The top-level Fitness prototype root currently uses the same VelocityCore scaffold as the other prototype roots. The architecture is multi-tenant and integration-ready, but it is not yet specialized for the Fitness domain.
