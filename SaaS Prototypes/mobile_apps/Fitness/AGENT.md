...
## Agent Rules For The Fitness Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Fitness exists in code.
...
- Any attempt to present this scaffold as a finished Fitness.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Fitness, add the domain model first.
