...
## Stable Context For baby_growth
...
### Missing Domain Work
- A true baby_growth data model
- Domain-specific workflows and UI
- Real admin and analytics behavior
- Production-safe auth and execution model

### Constraint
Do not describe this directory as a finished baby_growth until the code actually stops being the shared VelocityCore scaffold.
