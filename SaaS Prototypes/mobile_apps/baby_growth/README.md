...
# baby_growth Prototype

baby_growth is the intended product direction for this prototype root. The active code in this directory is currently the shared VelocityCore customer-operations scaffold. It is not yet a true baby_growth implementation.
...
- Any domain-specific baby_growth model or workflow.

### Planned
- Replace the shared VelocityCore assumptions with a true baby_growth domain model and workflow set.
...
## First Milestone
Replace the generic customer-operations data model and UI with baby_growth-specific behavior.
