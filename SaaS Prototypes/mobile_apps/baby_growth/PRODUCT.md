...
## Product Direction
- Prototype label: baby_growth
- Intended product: baby_growth
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a baby_growth product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a baby_growth product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future baby_growth product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real baby_growth workflow.
...
- baby_growth domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true baby_growth workflow.
...
### Free
- Audience: Builders evaluating the baby_growth prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted baby_growth workflow.
...
3. Replace one generic scaffold workflow with a real baby_growth workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with baby_growth-specific behavior.
