...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with baby_growth-specific behavior.
...
- [ ] A real baby_growth data model exists beyond shared scaffold entities.
- [ ] At least one true baby_growth workflow is implemented end to end.
