...
## Product Direction
- Prototype label: Grocery Delivery
- Intended product: Grocery Delivery
- Current code reality: shared VelocityCore customer-operations scaffold
- Value proposition: Provide a runnable starting point for teams exploring a Grocery Delivery product direction while making the scaffold status explicit.

## Target Users
- Builders evaluating a Grocery Delivery product direction
- Operators or founders who need a code-first starting point before domain-specific implementation

## Personas
- Founder or product lead validating a future Grocery Delivery product line.
- Operator who wants billing, communication, workflow, and reporting seams before deep domain implementation.
- Engineer responsible for replacing the shared scaffold with the first real Grocery Delivery workflow.
...
- Grocery Delivery domain entities are still missing and must replace or extend the shared models before this becomes a true product.
...
- Replace the generic flows above with the first true Grocery Delivery workflow.
...
### Free
- Audience: Builders evaluating the Grocery Delivery prototype locally.
...
### Pro
- Audience: Small teams piloting a hosted Grocery Delivery workflow.
...
3. Replace one generic scaffold workflow with a real Grocery Delivery workflow.
...
- First milestone: Replace the generic customer-operations data model and UI with Grocery Delivery-specific behavior.
