...
## Grocery Delivery Prototype Roadmap
...
- Decide whether this directory should remain a scaffold or become a real Grocery Delivery.

## Phase 2: Replace The Shared Scaffold
- Define the true Grocery Delivery domain model.
