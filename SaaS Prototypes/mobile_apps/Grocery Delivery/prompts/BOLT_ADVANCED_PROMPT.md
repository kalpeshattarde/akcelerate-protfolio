...
# BOLT Advanced Prompt - Grocery Delivery

Work in this prototype root only.

## Code Truth
- The top-level Grocery Delivery directory still contains the shared VelocityCore customer-operations scaffold.
- The first job is to respect the real code, not the folder label.

## Implementation Priority
1. Decide whether to keep the generic scaffold or convert it into a real Grocery Delivery.
2. If converting, add the missing Grocery Delivery data model and workflows first.
