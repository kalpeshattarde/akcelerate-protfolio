...
## Agent Rules For The Grocery Delivery Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Grocery Delivery exists in code.
...
- Any attempt to present this scaffold as a finished Grocery Delivery.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Grocery Delivery, add the domain model first.
