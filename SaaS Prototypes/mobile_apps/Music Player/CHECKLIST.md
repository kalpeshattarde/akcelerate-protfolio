...
- [ ] The first milestone is still accurate: Replace the generic customer-operations data model and UI with Music Player-specific behavior.
...
- [ ] A real Music Player data model exists beyond shared scaffold entities.
- [ ] At least one true Music Player workflow is implemented end to end.
