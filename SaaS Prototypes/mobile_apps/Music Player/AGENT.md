...
## Agent Rules For The Music Player Prototype

This prototype root still contains the shared VelocityCore customer-operations scaffold. Treat the directory name as the intended domain label, not as proof that a real Music Player exists in code.
...
- Any attempt to present this scaffold as a finished Music Player.

## Required Behavior
- Keep implemented versus scaffolded behavior explicit.
- If asked to make this a real Music Player, add the domain model first.
