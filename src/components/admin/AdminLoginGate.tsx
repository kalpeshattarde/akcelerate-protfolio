...
export const ROLE_PERMISSIONS: Record<AdminRole, string[]> = {
  super_admin: ["dashboard", "analytics", "funnel", "cohorts", "users", "orders", "content", "email", "products", "config", "brand", "affiliates", "growth", "ads", "activity", "live", "audit"],
  manager: ["dashboard", "analytics", "funnel", "cohorts", "users", "orders", "content", "email", "products", "brand", "activity", "live"],
