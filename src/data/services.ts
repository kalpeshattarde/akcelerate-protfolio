...
export const services: Service[] = [
  ...
  },
  {
    ...
    heroTitle: "Predict Demand.",
    heroSubtitle: "Optimize Everything.",
    description: "End-to-end supply chain intelligence with demand forecasting, inventory optimization, and logistics analytics that reduces costs and eliminates stockouts.",
    icon: "Truck",
    tags: ["Demand Forecasting", "Inventory Optimization", "Supplier Scoring", "Logistics", "Risk Assessment"],
    timelineTitle: "Full Visibility in 8 Weeks",
    serviceDetails: [
      { title: "Demand Forecasting", description: "ML-powered demand prediction using historical sales, seasonal patterns, promotions, and external market signals — adapting in real-time." },
      { title: "Inventory Optimization", description: "Dynamic reorder points, safety stock calculations, and ABC/XYZ classification that reduce excess inventory while preventing stockouts." },
      { title: "Supplier Performance Scoring", description: "Automated supplier scorecards tracking delivery reliability, quality metrics, price competitiveness, and compliance — with early warning alerts." },
      { title: "Logistics Route Optimization", description: "AI-optimized delivery routes considering traffic, fuel costs, delivery windows, and vehicle capacity — reducing logistics costs by 20%." },
      { title: "Risk Assessment", description: "Supply chain risk monitoring with disruption alerts, alternative supplier recommendations, and scenario modelling for business continuity." },
      { title: "Real-time Tracking Dashboards", description: "End-to-end visibility from purchase order to delivery — with live tracking, ETA predictions, and exception alerts." },
    ],
