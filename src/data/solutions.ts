...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    description: "Autonomous LLM-powered agents for sales, support and internal ops — wired into your CRM, knowledge base and SaaS stack.",
    icon: "Bot",
    features: [
      "Sales SDR & Support Agents",
      "Internal Copilots (RAG)",
      "Multi-Step Reasoning + Tool Calls",
      "CRM / DB / API Integrations",
      "Human-in-the-Loop Handoff",
      "Monitoring & Guardrails",
    ],
    benefits: [
      { title: "24/7 Coverage", description: "Agents that triage, qualify and respond without breaks.", metric: "24/7", metricLabel: "autonomous coverage" },
      { title: "Faster Response", description: "Cut first-response times from hours to seconds.", metric: "10x", metricLabel: "faster replies" },
      { title: "Lower Ops Cost", description: "Deflect repetitive tickets and free up your team.", metric: "60%", metricLabel: "ticket deflection" },
    ],
    process: [
      { step: 1, title: "Use-Case Discovery", description: "Pick the highest-leverage agent workflow." },
      { step: 2, title: "Knowledge & Tools", description: "Wire RAG sources, CRM and tool calls." },
      { step: 3, title: "Reasoning Loop", description: "Build agent planning + guardrails." },
      { step: 4, title: "Pilot", description: "Run with humans-in-the-loop, measure quality." },
      { step: 5, title: "Scale", description: "Roll out to production with monitoring." },
    ],
    industries: ["SaaS", "E-commerce", "Agencies", "B2B Services", "Startups"],
    relatedSlugs: ["business-automation", "automation-systems", "ai-ml"],
  },
  {
    slug: "business-automation",
    title: "Business Automation",
    shortTitle: "Business Automation",
    description: "End-to-end workflow automation — CRM, email, approvals and notifications stitched into deterministic n8n pipelines.",
    icon: "Zap",
    features: [
    ...
    benefits: [
      { title: "Hours Saved", description: "Hand off repetitive ops to bulletproof workflows.", metric: "20hrs", metricLabel: "saved per week" },
      { title: "Fewer Errors", description: "Deterministic flows replace manual copy-paste.", metric: "95%", metricLabel: "fewer errors" },
      { title: "Faster Handoffs", description: "Leads, tickets and approvals routed in seconds.", metric: "5x", metricLabel: "faster handoffs" },
    ],
    process: [
      { step: 1, title: "Workflow Audit", description: "Map every manual step worth automating." },
      { step: 2, title: "Design", description: "Diagram triggers, branches and failure paths." },
      { step: 3, title: "Build", description: "Develop in n8n with versioning + observability." },
      { step: 4, title: "Deploy", description: "Self-hosted or cloud, with monitoring." },
      { step: 5, title: "Iterate", description: "Tune flows and extend with your team." },
    ],
    industries: ["Agencies", "E-commerce", "SaaS", "Operations-heavy SMBs", "Startups"],
    relatedSlugs: ["ai-agents", "automation-systems", "consulting"],
  },
];
