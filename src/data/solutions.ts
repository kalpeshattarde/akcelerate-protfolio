...
export const solutions: Solution[] = [
  {
    ...
    services: [
      ...
      { title: "CRM & ERP Automation", description: "Automate lead scoring, follow-ups, invoicing, and data sync between Salesforce, HubSpot, SAP, Oracle, and custom ERPs." },
      { title: "Document Processing AI", description: "Extract, classify, and route data from invoices, contracts, and forms using OCR and NLP — reducing manual document handling by 90%." },
      { title: "Sales Pipeline Automation", description: "Automate lead nurturing, follow-up sequences, meeting scheduling, and deal tracking — so your sales team focuses on closing." },
      { title: "Custom Bot Development", description: "Build intelligent bots for Slack, Teams, WhatsApp, or your own platform — handling FAQs, ticket routing, and internal operations." },
    ],
  ...
  },
  {
    ...
    heroTitle: "Strategy That Delivers.",
    heroSubtitle: "Growth You Can Measure.",
    description: "Align technology investments with business goals. We help you identify the right AI use cases, build a phased transformation roadmap, and execute with measurable results.",
    icon: "Radio",
    tags: ["AI Strategy", "Digital Transformation", "Data Strategy", "ROI Forecasting", "Change Management"],
    stats: [
    ...
    services: [
      { title: "AI Readiness Assessment", description: "Evaluate your data maturity, tech stack, and team capability to determine the right entry point for AI adoption." },
      { title: "Digital Transformation Roadmap", description: "A phased, prioritised plan that aligns your digital investments with measurable business outcomes over 6-18 months." },
      { title: "Data Strategy Design", description: "Design your data architecture, governance framework, and analytics stack — from data lake to executive dashboard." },
      { title: "Technology Stack Advisory", description: "Independent, vendor-neutral guidance on platforms, tools, and build vs. buy decisions for your specific context." },
      { title: "Change Management", description: "Help your team adopt new tools and processes smoothly — training plans, stakeholder alignment, and phased rollouts." },
      { title: "ROI Forecasting", description: "Model the financial impact of proposed AI and digital investments before committing — including cost, timeline, and expected returns." },
    ],
