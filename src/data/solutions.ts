...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    services: [
      { title: "Cloud Architecture & Design", description: "Architect scalable, cost-optimised cloud environments on AWS, Azure, or GCP — with high availability, disaster recovery, and security built in from day one." },
      { title: "Cloud Migration", description: "Move workloads, databases, and applications to the cloud with zero downtime — using proven lift-and-shift, re-platform, or re-architect strategies." },
      { title: "CI/CD Pipeline Automation", description: "Automated build, test, and deployment pipelines using GitHub Actions, GitLab CI, Jenkins, or AWS CodePipeline — ship code multiple times per day." },
      { title: "Container & Kubernetes", description: "Containerise your applications with Docker and orchestrate with Kubernetes — auto-scaling, self-healing, and production-ready." },
