...
import { BarChart3, Settings, Package, Users, TrendingUp, Megaphone } from "lucide-react";
  ...
  return (
    <main className="pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-poppins text-3xl font-bold text-foreground mb-2">Admin Panel</h1>
